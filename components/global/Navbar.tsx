...
const Navbar = ({ showLinks = true }: { showLinks?: boolean }) => {
  ...
  return (
    <>
      <nav
        className={`sticky top-0 z-50 hidden items-center justify-between gap-6 px-8 py-4 transition-all duration-700 md:flex md:flex-col lg:flex-row ${
          scrollDir == "down"
          ...
          <>
            <ul className="flex items-center gap-x-4">
              ...
              <li className="hidden sm:block">
                <div className="h-6 border-l-2 border-gray-700"></div>
              </li>
        ...
        <AnimatePresence>
          {showLinks && showMobileMenu && (
            ...
            >
              ...
              <hr className="w-full border-0 border-t-2 border-gray-700" />
